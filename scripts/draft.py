...
def run(path, pathout, qcFilePrefix='016um_zoom_thr_100', qc_add=["qc_metrics", "rm_high_variable_genes"]):
    additional_plots = addQCplots(qc_add=qc_add, path=path, outPath=pathout, qcFilePrefix=qcFilePrefix)
...
if __name__ == "__main__":
    ...
    run(path, pathout, qc_add=["qc_metrics"])
