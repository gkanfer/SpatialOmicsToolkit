...
def run(path,pathout, qcFilePrefix = '002um_zoom_thr_100',plotPDF = ["qc","print","embd","writeAnndata"]):
    if plotPDF == "qc":
        viziumHD(path = path,outPath = pathout,totalThr = 100,geneThr = 100 , bins_gene_plot = 20,bins_gene_plot_thr = 20,qcFilePrefix = qcFilePrefix, qc = True)
    elif plotPDF == "print":
...
if __name__ == "__main__":
    path = "/data/kanferg/Sptial_Omics/playGround/Data/Visium_HD_Mouse_Brain_square_example/square_002um"
